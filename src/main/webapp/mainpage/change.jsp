		...
		<form action="change.do" method="post" name="frm">
			<div class="asbg op">
				...
				<div class="asitem con">
					<p class="op2">
						<input type="checkbox" name="asitem" value="휴대폰" readonly>스마트
						폰
					</p>
					<p class="op2">
			...
			<div class="datebg op">
				...
				<div class="date con">
                    ...
                    %>
					<input type="radio" name="res_date"
						style="font-size: 17px; width: 20px; height: 20px"
			...
			<div class="timebg op">
				<h2>시간 선택</h2>
				<div class="time con">
					<input type="radio" name="res_time" value="13:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>13:00 <input type="radio" name="res_time" value="14:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>14:00 <input type="radio" name="res_time" value="15:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>15:00 <input type="radio" name="res_time" value="16:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>16:00 <input type="radio" name="res_time" value="17:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>17:00 <input type="radio" name="res_time" value="18:00"
						style="font-size: 17px; width: 20px; height: 20px"
					>18:00
				</div>
			</div>
			...
			<div class="prbg op">
				<div class="prflex">
					...
					<div class="pr con">
						<h4>이름</h4>
						<input type="text" name="name" value="${rdto.name}" size="20"
							readonly
						><br>
						<h4>전화번호</h4>
						<input type="text" name="phone" value="${rdto.phone}" size="20"
							readonly
						><br>
						<h4>이메일</h4>
						<input type="text" name="email" value="${rdto.email}" size="20"
							readonly
						><br>
					</div>
				</div>
				<div class="btn">
					<input type="radio" name="check" value="a" checked>본인 <input
						type="radio" name="check" value="b"
					>대리
				</div>
			</div>
			<hr>
